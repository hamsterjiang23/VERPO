...
# Some Slurm images export AMD visibility variables on NVIDIA nodes. Explicit
# empty values keep stale Ray processes and actors from reintroducing them;
# veRL workers reject simultaneous CUDA and ROCm visibility variables.
_non_rocm_ray_env = {}
if torch.version.hip is None:
    _non_rocm_ray_env = {"ROCR_VISIBLE_DEVICES": "", "HIP_VISIBLE_DEVICES": ""}
